...
namespace timos
{
    [sc2i.win32.data.navigation.ObjectListeur(typeof(CTypeRessource))]
    public class CFormListeTypeRessource : CFormListeStandardTimos, IFormNavigable
    {
        /// <summary>
        ...
        //-----------------------------------------------------------------------
        public CFormListeTypeRessource()
            :base(typeof(CTypeRessource))
        {
        ...
        {
            return I.T("Resources Types list|251");
        }
