...
{
	[sc2i.win32.data.navigation.ObjectListeur(typeof(CEtapeWorkflow))]
	public class CFormListeEtapesWorkflow : CFormListeStandardTimos, IFormNavigable
	{
		
		private System.ComponentModel.IContainer components = null;

        public CFormListeEtapesWorkflow()
		...
		protected override void InitPanel()
		{
            ...
            m_panelListe.ControlFiltreStandard = new CPanelFiltreEtapesWorkflow();
        ...
        {
            return I.T("Workflows Steps|20615");
		}
