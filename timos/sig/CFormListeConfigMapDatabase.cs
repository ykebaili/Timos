...
namespace timos
{
	[sc2i.win32.data.navigation.ObjectListeur(typeof(CConfigMapDatabase))]
	public class CFormListeConfigMapDataBase : CFormListeStandardTimos, IFormNavigable
	{
		
		private System.ComponentModel.IContainer components = null;

        public CFormListeConfigMapDataBase()
			:base(typeof(CConfigMapDatabase))
		{
        ...
        {
            return I.T("Map setup list|20840");
		}
		//-------------------------------------------------------------------
	}
}
