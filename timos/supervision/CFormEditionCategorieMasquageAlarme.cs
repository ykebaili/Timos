...
namespace timos
{
	[sc2i.win32.data.navigation.ObjectEditeur(typeof(CCategorieMasquageAlarme))]
	public class CFormEditionCategorieMasquageAlarme : CFormEditionStdTimos, IFormNavigable
	{
		...
		public CFormEditionCategorieMasquageAlarme()
			:base()
		{
		...
		//-------------------------------------------------------------------------
		public CFormEditionCategorieMasquageAlarme(CCategorieMasquageAlarme civilite)
			:base(civilite)
		{
			// Cet appel est requis par le Concepteur Windows Form.
			InitializeComponent();
		...
		//-------------------------------------------------------------------------
		public CFormEditionCategorieMasquageAlarme(CCategorieMasquageAlarme civilite, CListeObjetsDonnees liste)
			:base(civilite, liste)
		{
			// Cet appel est requis par le Concepteur Windows Form.
			InitializeComponent();
		...
		private void InitializeComponent()
		{
            ...
            this.c2iPanelOmbre4.Size = new System.Drawing.Size(537, 168);
            ...
            this.m_numPriorite.Location = new System.Drawing.Point(132, 93);
            ...
            this.label5.Text = "Indicate the Masking priority|10306";
            // 
            // label6
            // 
            ...
            this.label6.Size = new System.Drawing.Size(295, 53);
            ...
            this.label6.Text = "If an Alarm is potentialy masked by several Filters, the one wich Masking Categor" +
                "y has the highest priority will be applied|10307";
            // 
            // label4
            // 
            ...
            // 
            // CFormEditionCategorieMasquageAlarme
            // 
            ...
            this.Name = "CFormEditionCategorieMasquageAlarme";
        ...
        //-------------------------------------------------------------------------
		private CCategorieMasquageAlarme CategorieMasquageAlarme
		{
			get
			{
				return (CCategorieMasquageAlarme)ObjetEdite;
			}
		}
		...
		protected override CResultAErreur MyInitChamps()
		{
            ...
            AffecterTitre(I.T("Masking Category @1|10", CategorieMasquageAlarme.Libelle));
