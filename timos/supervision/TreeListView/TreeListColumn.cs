...
namespace timos.supervision
{
	...
	public class TreeListColumnCollection : IList<TreeListColumn>, IList
	{
		...
		public void RecalcVisibleColumsRect(bool isDoingColumnResizing)
		{
			...
			/*
			timos.supervision.Tracing.WriteLine(0, "\nRecalcVisibleColumsRect");
			timos.supervision.Tracing.WriteLine(0, "WidthRequired, auto {0}, fixed {1}, total {2}", 
			...
			*/
			...
			/*
			timos.supervision.Tracing.WriteLine(0, "ClientWidth {0}", clientWidth);
			timos.supervision.Tracing.WriteLine(0, "RemainngWidth {0}, TotalRatio {1},  RatioUnits {2}", 
				remainingWidth,
				totalRatio,
				ratioUnit);
			*/
