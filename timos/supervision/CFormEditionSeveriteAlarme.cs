...
namespace timos
{
	[sc2i.win32.data.navigation.ObjectEditeur(typeof(CSeveriteAlarme))]
	public class CFormEditionSeveriteAlarme : CFormEditionStdTimos, IFormNavigable
	{
        ...
        private NumericUpDown m_numPriorite;
        private Label label6;
		private System.ComponentModel.IContainer components = null;

		public CFormEditionSeveriteAlarme()
			:base()
		{
		...
		//-------------------------------------------------------------------------
		public CFormEditionSeveriteAlarme(CSeveriteAlarme civilite)
			:base(civilite)
		{
			// Cet appel est requis par le Concepteur Windows Form.
			InitializeComponent();
		...
		//-------------------------------------------------------------------------
		public CFormEditionSeveriteAlarme(CSeveriteAlarme civilite, CListeObjetsDonnees liste)
			:base(civilite, liste)
		{
			// Cet appel est requis par le Concepteur Windows Form.
			InitializeComponent();
		...
		private void InitializeComponent()
		{
            ...
            this.m_numPriorite = new System.Windows.Forms.NumericUpDown();
            ...
            this.c2iPanelOmbre4.Size = new System.Drawing.Size(537, 194);
            ...
            this.m_numPriorite.Location = new System.Drawing.Point(132, 129);
            ...
            this.m_numPriorite.Size = new System.Drawing.Size(79, 20);
            ...
            this.m_numPriorite.TabIndex = 4008;
            // 
            // label6
            // 
            ...
            this.label6.Text = "If level is more than 49, equipments or links will be considered as out of order|" +
                "20365";
            // 
            // c2iTextBox1
            // 
            ...
            this.label5.Text = "Indicate the Severity priority|10216";
            // 
            // CFormEditionSeveriteAlarme
            // 
            ...
            this.Name = "CFormEditionSeveriteAlarme";
        ...
        //-------------------------------------------------------------------------
		private CSeveriteAlarme SeveriteAlarme
		{
			get
			{
				return (CSeveriteAlarme)ObjetEdite;
			}
		}
		...
		protected override CResultAErreur MyInitChamps()
		{
            ...
            AffecterTitre(I.T("Alarm Severity @1|10215", SeveriteAlarme.Libelle));

            m_panelCouleur.BackColor = SeveriteAlarme.Couleur;
        ...
        protected override CResultAErreur MAJ_Champs()
        {
            ...
            if(result)
                SeveriteAlarme.Couleur = m_panelCouleur.BackColor;
