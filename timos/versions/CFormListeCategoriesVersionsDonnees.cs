...
{
	[sc2i.win32.data.navigation.ObjectListeur(typeof(CCategorieVersionDonnees))]
	public class CFormListeCategoriesVersionsDonnees :
		...
		IFormNavigable
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CFormListeCategoriesVersionsDonnees));
			...
			// 
			// CFormListeCategoriesVersionsDonnees
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
			this.ClientSize = new System.Drawing.Size(448, 376);
			this.Name = "CFormListeCategoriesVersionsDonnees";
		...
		//-------------------------------------------------------------------
		public CFormListeCategoriesVersionsDonnees()
			: base(typeof(CCategorieVersionDonnees))
		{
		...
		//-------------------------------------------------------------------
		public CFormListeCategoriesVersionsDonnees(string strCodeRole)
			: base(typeof(CCategorieVersionDonnees))
		{
			// Cet appel est requis par le Concepteur Windows Form.
			InitializeComponent();
		...
		protected override void InitPanel()
		{
			m_panelListe.InitFromListeObjets(
				m_listeObjets,
				typeof(CCategorieVersionDonnees),
				null, "");
        ...
        {
            return I.T("List of Data version categories|20037");
		}
		#endregion
