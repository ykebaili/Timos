...
{
	[sc2i.win32.data.navigation.ObjectListeur(typeof(CTypeAuditVersion))]
	public class CFormListeTypeAuditVersion :
		...
		IFormNavigable
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CFormListeTableParametrable));
			...
			// 
			// CFormListeTableParametrable
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
			this.ClientSize = new System.Drawing.Size(448, 376);
			this.Name = "CFormListeTableParametrable";
		...
		//-------------------------------------------------------------------
		public CFormListeTypeAuditVersion()
			: base(typeof(CTypeAuditVersion))
		{
		...
		//-------------------------------------------------------------------
		public CFormListeTypeAuditVersion(string strCodeRole)
			: base(typeof(CTypeAuditVersion))
		{
			// Cet appel est requis par le Concepteur Windows Form.
			InitializeComponent();
        ...
        {
            return I.T("List of Audit Type for Version|1389");
		}
		#endregion
