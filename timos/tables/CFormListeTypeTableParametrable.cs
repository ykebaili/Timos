...
namespace timos
{
    [sc2i.win32.data.navigation.ObjectListeur(typeof(CTypeTableParametrable))]
    public class CFormListeTypeTableParametrable :
        ...
        IFormNavigable
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CFormListeTypeTableParametrable));
			...
			// 
			// CFormListeTypeTableParametrable
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
			this.ClientSize = new System.Drawing.Size(448, 376);
			this.Name = "CFormListeTypeTableParametrable";
		...
		//-------------------------------------------------------------------
        public CFormListeTypeTableParametrable()
			: base(typeof(CTypeTableParametrable))
        {
        ...
        //-------------------------------------------------------------------
		public CFormListeTypeTableParametrable(string strCodeRole)
            : base(typeof(CTypeTableParametrable))
        {
            // Cet appel est requis par le Concepteur Windows Form.
            InitializeComponent();
        ...
        {
            return I.T("List of custom table types|1193");
		}
		#endregion
