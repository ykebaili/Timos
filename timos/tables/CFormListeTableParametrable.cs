...
namespace timos
{
	[sc2i.win32.data.navigation.ObjectListeur(typeof(CTableParametrable))]
	public class CFormListeTableParametrable :
		...
		IFormNavigable
	{
		...
		//-------------------------------------------------------------------
		public CFormListeTableParametrable()
			: base(typeof(CTableParametrable))
		{
		...
		//-------------------------------------------------------------------
		public CFormListeTableParametrable(string strCodeRole)
			: base(typeof(CTableParametrable))
		{
			// Cet appel est requis par le Concepteur Windows Form.
			InitializeComponent();
        ...
        {
            return I.T("List of Custom Tables|1192");
		}
		#endregion
