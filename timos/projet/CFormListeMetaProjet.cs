...
namespace timos
{
    [sc2i.win32.data.navigation.ObjectListeur(typeof(CMetaProjet))]
	public class CFormListeMetaProjet : CFormListeStandardTimos
	{
		
		private System.ComponentModel.IContainer components = null;

        public CFormListeMetaProjet()
            : base(typeof(CMetaProjet))
		{
			// Cet appel est requis par le Concepteur Windows Form.
			InitializeComponent();
		}
		public CFormListeMetaProjet(CListeObjetsDonnees lst)
			: base(lst)
		{
			InitializeComponent();
		}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CFormListeMetaProjet));
        ...
        {
            return I.T("Meta Projects list|20521");
		}
