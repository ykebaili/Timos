...
namespace timos
{
	[sc2i.win32.data.navigation.ObjectListeur(typeof(CTypeContrat))]
	public class CFormListeTypeContrat : CFormListeStandardTimos, IFormNavigable
	{
		
		private System.ComponentModel.IContainer components = null;

		public CFormListeTypeContrat()
			:base(typeof(CTypeContrat))
		{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CFormListeTypeContrat));
        ...
        {
            return I.T("Contract Types List|1130");
		}
		//-------------------------------------------------------------------
	}
}
