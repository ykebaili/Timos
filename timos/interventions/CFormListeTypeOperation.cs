...
namespace timos
{
	[sc2i.win32.data.navigation.ObjectListeur(typeof(CTypeOperation))]
	public class CFormListeTypeOperation : CFormListeStandardTimos, IFormNavigable
	{
		
		private System.ComponentModel.IContainer components = null;

		public CFormListeTypeOperation()
			:base(typeof(CTypeOperation))
		{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CFormListeTypeOperation));
        ...
        {
            return I.T("Operation Types|322");
		}
		//-------------------------------------------------------------------
	}
}
