...
namespace timos
{
	[sc2i.win32.data.navigation.ObjectListeur(typeof(CIntervention))]
	public class CFormListeInterventions : CFormListeStandardTimos, IFormNavigable
	{
		
		private System.ComponentModel.IContainer components = null;

		public CFormListeInterventions()
			:base(typeof(CIntervention))
		{
			// Cet appel est requis par le Concepteur Windows Form.
			InitializeComponent();
		}

		public CFormListeInterventions(CListeObjetsDonnees lst)
			: base(lst)
		{
			InitializeComponent();
		}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CFormListeInterventions));
        ...
        {
            return I.T("Interventions list|886");
		}
		//-------------------------------------------------------------------
	}
}
