...
namespace timos
{
	[sc2i.win32.data.navigation.ObjectListeur(typeof(CProfilElement))]
	public class CFormListeProfilElement : CFormListeStandardTimos, IFormNavigable
	{
		
		private System.ComponentModel.IContainer components = null;

		public CFormListeProfilElement()
			:base(typeof(CProfilElement))
		{
			// Cet appel est requis par le Concepteur Windows Form.
			InitializeComponent();
		}

		public CFormListeProfilElement(CListeObjetsDonnees liste)
			: base(liste)
		{
			InitializeComponent();
		}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CFormListeProfilElement));
        ...
        {
            return I.T("Element profiles list|887");
		}
		//-------------------------------------------------------------------
	}
}
