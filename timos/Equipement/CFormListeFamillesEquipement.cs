...
namespace timos   
{
	[sc2i.win32.data.navigation.ObjectListeur(typeof(CFamilleEquipement))]
	public class CFormListeFamillesEquipement : CFormListeStandardTimos, IFormNavigable
	{
		private System.ComponentModel.IContainer components = null;

		public CFormListeFamillesEquipement()
			:base(typeof(CFamilleEquipement))
		{
		...
		private void InitializeComponent()
		{
			...
			// 
			// CFormListeFamillesEquipement
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
			this.ClientSize = new System.Drawing.Size(504, 376);
			this.Name = "CFormListeFamillesEquipement";
        ...
        {
            return I.T("Equipment Family list|190");
		}
