...
namespace timos
{
	[ObjectListeur(typeof(CTypeStock))]
	public class CFormListeTypesStocks : CFormListeStandardTimos, IFormNavigable
	{
		
		private System.ComponentModel.IContainer components = null;

		public CFormListeTypesStocks()
			:base(typeof(CTypeStock))
		{
        ...
        {
            return I.T("Stocks Types list|205");
		}
		//-------------------------------------------------------------------
	}
}
