...
namespace timos
{
	[sc2i.win32.data.navigation.ObjectListeur(typeof(CTypeEquipementLogique))]
	public class CFormListeTypesEquipementsLogiques : CFormListeStandardTimos, IFormNavigable
	{
		
		private System.ComponentModel.IContainer components = null;

		public CFormListeTypesEquipementsLogiques()
			:base(typeof(CTypeEquipementLogique))
		{
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CFormListeTypesEquipementsLogiques));
            ...
            // 
			// CFormListeTypesEquipementsLogiques
            // 
            this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
            this.ClientSize = new System.Drawing.Size(448, 376);
			this.Name = "CFormListeTypesEquipementsLogiques";
		...
		protected override void InitPanel()
		{
			m_panelListe.InitFromListeObjets(
				m_listeObjets,
				typeof(CTypeEquipementLogique),	
				null, "");

			m_panelListe.RemplirGrille();
		}
		//-------------------------------------------------------------------
		protected override void AffecterTitre()
		{
			CTimosApp.Titre = I.T( "Logical equipment Types list|20055");
		}
		//-------------------------------------------------------------------
	}
}
