...
{
    public enum EApparenceElementListeComposantPhysique
    {
        Icone,
        Texte,
        Icone_Texte,
    ...
    public class CElementListeComposantPhysique : System.Windows.Forms.Control
    {
        ...
        private EApparenceElementListeComposantPhysique m_apparence = EApparenceElementListeComposantPhysique.Icone_Texte;
        public EApparenceElementListeComposantPhysique Apparence
        {
            get
            {
                return m_apparence;
        ...
        public CElementListeComposantPhysique()
        {
            InitializeComponent();
        }
        ...
        private void CElementListeWnd_Paint(object sender, System.Windows.Forms.PaintEventArgs e)
        {
            ...
            if (Apparence != EApparenceElementListeComposantPhysique.Icone)
            {
                if (Apparence == EApparenceElementListeComposantPhysique.Texte
                    || Apparence == EApparenceElementListeComposantPhysique.Texte_Icone
                    || Image == null)
            ...
            if (Apparence != EApparenceElementListeComposantPhysique.Texte && Image != null)
            {
                if (Apparence == EApparenceElementListeComposantPhysique.Icone_Texte
                    || Apparence == EApparenceElementListeComposantPhysique.Icone)
                {
