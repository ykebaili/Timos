...
namespace timos
{
    [sc2i.win32.data.navigation.ObjectListeur(typeof(CSystemeCoordonnees))]
    public class CFormListeSystemeCoordonnees :
        ...
        IFormNavigable
    {
        ...
        //-------------------------------------------------------------------
        public CFormListeSystemeCoordonnees()
            : base(typeof(CSystemeCoordonnees))
        {
        ...
        //-------------------------------------------------------------------
        public CFormListeSystemeCoordonnees(string strCodeRole)
            : base(typeof(CSystemeCoordonnees))
        {
            // Cet appel est requis par le Concepteur Windows Form.
            InitializeComponent();
        ...
        private void InitializeComponent()
        {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CFormListeSystemeCoordonnees));
			...
			// 
			// CFormListeSystemeCoordonnees
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
			this.ClientSize = new System.Drawing.Size(448, 376);
			this.Name = "CFormListeSystemeCoordonnees";
        ...
        protected override void InitPanel()
        {
            m_panelListe.InitFromListeObjets(
                ...
                typeof(CFormEditionSystemeCoordonnees),
                null, "");
        ...
        {
            return I.T("Coordinate System|430");
        }


        private void m_panelListe_OnNewObjetDonnee(object sender, sc2i.data.CObjetDonnee nouvelObjet, ref bool bCancel)
        {
            //if (nouvelObjet is CSystemeCoordonnees && m_strCodeRole != "")
            //    ((CSystemeCoordonnees)nouvelObjet).CodeRole = m_strCodeRole;
        }
    }
}
