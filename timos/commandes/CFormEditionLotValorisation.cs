...
{
	[sc2i.win32.data.navigation.ObjectEditeur(typeof(CLotValorisation))]
	public class CFormEditionLotValorisation : CFormEditionStdTimos, IFormNavigable
    {
        private CControleEditeLotValorisation m_editeurLot;
		private System.ComponentModel.IContainer components = null;

		public CFormEditionLotValorisation()
			:base()
		{
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CFormEditionLotValorisation));
            ...
            // m_panelMenu
            // 
            this.m_panelMenu.Size = new System.Drawing.Size(776, 28);
            ...
            // m_editeurLot
            // 
            this.m_editeurLot.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
            ...
            this.m_extLinkField.SetLinkFieldAutoUpdate(this.m_editeurLot, false);
            this.m_editeurLot.Location = new System.Drawing.Point(0, 38);
            this.m_editeurLot.LockEdition = true;
            ...
            this.m_editeurLot.Size = new System.Drawing.Size(776, 373);
            ...
            this.m_editeurLot.TabIndex = 4004;
            // 
            // CFormEditionLotValorisation
            // 
		...
		#endregion
		//-------------------------------------------------------------------------
		private CLotValorisation LotValorisation
		{
			get
			{
				return (CLotValorisation)ObjetEdite;
			}
		}
		//-------------------------------------------------------------------------
		protected override CResultAErreur MyInitChamps()
		{
            AffecterTitre(I.T("Valuation lot @1|20452", LotValorisation.Libelle));
            CResultAErreur result = base.MyInitChamps();

            if (result)
                result = m_editeurLot.InitChamps(LotValorisation);
			return result;
		}
		//-------------------------------------------------------------------------
