...
{
	[sc2i.win32.data.navigation.ObjectListeur(typeof(CTypeCommande))]
	public class CFormListeTypeCommandes : CFormListeStandardTimos, IFormNavigable
	{
		
		private System.ComponentModel.IContainer components = null;

		public CFormListeTypeCommandes()
			:base(typeof(CTypeCommande))
		{
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CFormListeTypeCommandes));
        ...
        {
            return I.T("Order types list|20391");
		}
		//-------------------------------------------------------------------
	}
}
