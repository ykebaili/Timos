...
{
	[sc2i.win32.data.navigation.ObjectListeur(typeof(CLivraisonEquipement))]
	public class CFormListeLivraisonEquipements : CFormListeStandardTimos, IFormNavigable
	{
		
		private System.ComponentModel.IContainer components = null;

		public CFormListeLivraisonEquipements()
			:base(typeof(CLivraisonEquipement))
		{
...
System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CFormListeLivraisonEquipements));
...
glColumn2.Name = "Name";
glColumn2.Propriete = "Commande.Fournisseur.Acteur.IdentiteComplete";
glColumn2.Text = "Supplier|20389";
...
// 
// CFormListeLivraisonEquipements
// 
this.ClientSize = new System.Drawing.Size(448, 376);
this.Name = "CFormListeLivraisonEquipements";
...
this.ResumeLayout(false);
        ...
        {
            return I.T("Delivery list|20414");
		}
		//-------------------------------------------------------------------
	}
}
