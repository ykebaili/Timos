...
{
	[sc2i.win32.data.navigation.ObjectEditeur(typeof(CTypeCommande))]
	public class CFormEditionTypeCommande : CFormEditionStdTimos, IFormNavigable
	{
		...
		public CFormEditionTypeCommande()
			:base()
		{
		...
		//-------------------------------------------------------------------------
		public CFormEditionTypeCommande(CTypeCommande TypeCommande)
			:base(TypeCommande)
		{
			// Cet appel est requis par le Concepteur Windows Form.
			InitializeComponent();
		...
		//-------------------------------------------------------------------------
		public CFormEditionTypeCommande(CTypeCommande TypeCommande, CListeObjetsDonnees liste)
			:base(TypeCommande, liste)
		{
			// Cet appel est requis par le Concepteur Windows Form.
			InitializeComponent();
		}
		...
		private void InitializeComponent()
		{
            ...
            // m_panelNavigation
            // 
            this.m_panelNavigation.Location = new System.Drawing.Point(471, 0);
            ...
            // m_panelCle
            // 
            this.m_panelCle.Location = new System.Drawing.Point(363, 0);
            ...
            // m_panelMenu
            // 
            this.m_panelMenu.Size = new System.Drawing.Size(646, 28);
            ...
            this.m_tabControl.Anchor = AnchorStyles.Left | AnchorStyles.Right | AnchorStyles.Top | AnchorStyles.Bottom;
            this.m_tabControl.Location = new System.Drawing.Point(8, 102);
            ...
            this.m_tabControl.SelectedTab = this.m_pageChamps;
            this.m_tabControl.Size = new System.Drawing.Size(640, 289);
            ...
            this.m_pageChamps.Size = new System.Drawing.Size(624, 248);
            ...
            this.m_panelEditChamps.Size = new System.Drawing.Size(624, 248);
            ...
            this.Name = "CFormEditionTypeCommande";
            this.m_extStyle.SetStyleBackColor(this, sc2i.win32.common.CExtStyle.EnumCouleurs.None);
            this.m_extStyle.SetStyleForeColor(this, sc2i.win32.common.CExtStyle.EnumCouleurs.None);
            this.TabControl = this.m_tabControl;
            this.OnInitPage += new sc2i.win32.data.navigation.EventOnPageHandler(this.CFormEditionTypeCommande_OnInitPage);
            this.OnMajChampsPage += new sc2i.win32.data.navigation.EventOnPageHandler(this.CFormEditionTypeCommande_OnMajChampsPage);
		...
		#endregion
		//-------------------------------------------------------------------------
		private CTypeCommande TypeCommande
		{
			get
			{
				return (CTypeCommande)ObjetEdite;
			}
		}
		//-------------------------------------------------------------------------
		protected override CResultAErreur MyInitChamps()
		{
			...
			AffecterTitre(I.T( "Order type @1|20392", TypeCommande.Libelle));
			return result;
		}
		//-------------------------------------------------------------------------
