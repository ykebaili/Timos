...
{
	[sc2i.win32.data.navigation.ObjectEditeur(typeof(CTypeLivraisonEquipement))]
	public class CFormEditionTypeLivraisonEquipement : CFormEditionStdTimos, IFormNavigable
	{
		...
		public CFormEditionTypeLivraisonEquipement()
			:base()
		{
		...
		//-------------------------------------------------------------------------
		public CFormEditionTypeLivraisonEquipement(CTypeLivraisonEquipement TypeLivraisonEquipement)
			:base(TypeLivraisonEquipement)
		{
			// Cet appel est requis par le Concepteur Windows Form.
			InitializeComponent();
		}
		//-------------------------------------------------------------------------
		public CFormEditionTypeLivraisonEquipement(CTypeLivraisonEquipement TypeLivraisonEquipement, CListeObjetsDonnees liste)
			:base(TypeLivraisonEquipement, liste)
		{
			// Cet appel est requis par le Concepteur Windows Form.
			InitializeComponent();
		}
		...
		private void InitializeComponent()
		{
            ...
            // 
            // CFormEditionTypeLivraisonEquipement
            // 
            ...
            this.Name = "CFormEditionTypeLivraisonEquipement";
            this.m_extStyle.SetStyleBackColor(this, sc2i.win32.common.CExtStyle.EnumCouleurs.None);
            this.m_extStyle.SetStyleForeColor(this, sc2i.win32.common.CExtStyle.EnumCouleurs.None);
            this.TabControl = this.m_tabControl;
            this.OnInitPage += new sc2i.win32.data.navigation.EventOnPageHandler(this.CFormEditionTypeLivraisonEquipement_OnInitPage);
            this.OnMajChampsPage += new sc2i.win32.data.navigation.EventOnPageHandler(this.CFormEditionTypeLivraisonEquipement_OnMajChampsPage);
		...
		#endregion
		//-------------------------------------------------------------------------
		private CTypeLivraisonEquipement TypeLivraisonEquipement
		{
			get
			{
				return (CTypeLivraisonEquipement)ObjetEdite;
			}
		}
		//-------------------------------------------------------------------------
		protected override CResultAErreur MyInitChamps()
		{
			...
			AffecterTitre(I.T( "Delivery type @1|20411", TypeLivraisonEquipement.Libelle));
			return result;
		}
		//-------------------------------------------------------------------------
        ...
        private CResultAErreur CFormEditionTypeLivraisonEquipement_OnInitPage(object page)
        {
            CResultAErreur result = CResultAErreur.True;
            if (page == m_pageChamps)
            {
                m_panelEditChamps.InitPanel(
                    TypeLivraisonEquipement,
