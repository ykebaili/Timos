...
namespace timos
{
    [sc2i.win32.data.navigation.ObjectListeur(typeof(CFamilleSymbole))]
    public class CFormListeFamilleSymbole : CFormListeStandardTimos
    {

        private System.ComponentModel.IContainer components = null;

        public CFormListeFamilleSymbole()
            : base(typeof(CFamilleSymbole))
        {
        ...
        {
            return I.T("Symbol family list|30022");
        }
