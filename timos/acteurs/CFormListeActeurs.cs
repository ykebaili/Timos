...
namespace timos
{
	...
	public class CFormListeActeurs : CFormListeStandardTimos, IFormNavigable
	{
		
		private System.ComponentModel.IContainer components = null;

		//-------------------------------------------------------------------
		public CFormListeActeurs()
			:base(typeof(CActeur))
		{
			// Cet appel est requis par le Concepteur Windows Form.
			InitializeComponent();
			FiltreRapide = new CFiltreData ( CActeur.c_champNom+" like @1", "");
		}
		//-------------------------------------------------------------------
		/// <summary>
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CFormListeActeurs));
            ...
            glColumn3.Text = "Postal/Zip code|756";
            ...
            this.Name = "CFormListeActeurs";
            this.m_extStyle.SetStyleBackColor(this, sc2i.win32.common.CExtStyle.EnumCouleurs.None);
            this.m_extStyle.SetStyleForeColor(this, sc2i.win32.common.CExtStyle.EnumCouleurs.None);
            this.Load += new System.EventHandler(this.CFormListeActeurs_Load);
        ...
        {
            return I.T("Members list|765");
		}

		//-------------------------------------------------------------------
		private void CFormListeActeurs_Load(object sender, System.EventArgs e)
		{
            /*CFormTestFiltreFormule frm = new CFormTestFiltreFormule();
            frm.ShowDialog();*/
		}
		//-------------------------------------------------------------------
	}
