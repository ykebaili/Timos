...
namespace timos   
{
	[sc2i.win32.data.navigation.ObjectListeur(typeof(CTypeEntiteOrganisationnelle))]
	public class CFormListeTypeEntiteOrganisationnelle : CFormListeStandardTimos, IFormNavigable
	{
		private System.ComponentModel.IContainer components = null;

		public CFormListeTypeEntiteOrganisationnelle()
			:base(typeof(CTypeEntiteOrganisationnelle))
		{
		...
		private void InitializeComponent()
		{
			...
			// 
			// CFormListeTypeEntiteOrganisationnelle
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
			this.ClientSize = new System.Drawing.Size(504, 376);
			this.Name = "CFormListeTypeEntiteOrganisationnelle";
        ...
        {
            return I.T("Organizational Entities type list|110");
		}
		...
		protected override void InitPanel()
		{
			m_panelListe.InitFromListeObjets(
				m_listeObjets,
				typeof(CTypeEntiteOrganisationnelle),
				null, "");
