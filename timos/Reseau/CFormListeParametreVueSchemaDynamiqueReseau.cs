...
namespace timos
{
    [sc2i.win32.data.navigation.ObjectListeur(typeof(CParametreVueSchemaDynamique))]
    public class CFormListeParametreVueSchemaDynamique : CFormListeStandardTimos, IFormNavigable
    {

        private System.ComponentModel.IContainer components = null;

        public CFormListeParametreVueSchemaDynamique()
            : base(typeof(CParametreVueSchemaDynamique))
        {
        ...
        private void InitializeComponent()
        {
            ...
            // 
            // CFormListeParametreVueSchemaDynamique
            // 
            this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
            this.ClientSize = new System.Drawing.Size(448, 376);
            this.Name = "CFormListeParametreVueSchemaDynamique";
        ...
        protected override void InitPanel()
        {
            m_panelListe.InitFromListeObjets(
                m_listeObjets,
                typeof(CParametreVueSchemaDynamique),
                null, "");
        ...
        {
            return I.T("Dynamic network diagram views|20152");
        }
