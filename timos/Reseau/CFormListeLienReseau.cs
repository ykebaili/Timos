...
namespace timos
{
    [sc2i.win32.data.navigation.ObjectListeur(typeof(CLienReseau))]
	public class CFormListeLienReseau : CFormListeStandardTimos
	{
		
		private System.ComponentModel.IContainer components = null;

        private CFiltreData m_filtreElementsLies = null;

        public CFormListeLienReseau()
            : base(typeof(CLienReseau))
		{
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CFormListeTypeSite));
        ...
        {
            return I.T("Network links list|30349");
		}

        public CFiltreData FiltreElementsLies
        {
            get
            {
                return m_filtreElementsLies;
            }
            set
            {
                m_filtreElementsLies = value;
            }
        }
		...
		protected override void InitPanel()
		{
            ...
            if (m_filtreElementsLies != null)
                m_listeObjets.Filtre = m_filtreElementsLies;
