...
namespace timos
{
    [sc2i.win32.data.navigation.ObjectListeur(typeof(CGPSCarte))]
	public class CFormListeGPSCartes : CFormListeStandardTimos
	{
		
		private System.ComponentModel.IContainer components = null;

        public CFormListeGPSCartes()
            : base(typeof(CGPSCarte))
		{
