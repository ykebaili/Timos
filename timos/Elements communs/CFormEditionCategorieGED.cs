...
namespace timos
{
	[sc2i.win32.data.navigation.ObjectEditeur(typeof(CCategorieGED))]
	public class CFormEditionCategorieGED : CFormEditionStdTimos, IFormNavigable
	{
        ...
        private Crownwood.Magic.Controls.TabPage pageDefChamps;
		...
		public CFormEditionCategorieGED()
			:base()
		{
		...
		//-------------------------------------------------------------------------
		public CFormEditionCategorieGED(CCategorieGED CategorieGED)
			:base(CategorieGED)
		{
			// Cet appel est requis par le Concepteur Windows Form.
			InitializeComponent();
		...
		//-------------------------------------------------------------------------
		public CFormEditionCategorieGED(CCategorieGED CategorieGED, CListeObjetsDonnees liste)
			:base(CategorieGED, liste)
		{
			// Cet appel est requis par le Concepteur Windows Form.
			InitializeComponent();
		}
		...
		private void InitializeComponent()
		{
            ...
            this.pageDefChamps = new Crownwood.Magic.Controls.TabPage();
            ...
            this.pageDefChamps.SuspendLayout();
            ...
            this.label1.Text = "Category label|891";
            ...
            // pageDefChamps
            // 
            this.pageDefChamps.Controls.Add(this.m_panelEditDefinisseurChampsCustom);
            this.m_extLinkField.SetLinkField(this.pageDefChamps, "");
            this.pageDefChamps.Location = new System.Drawing.Point(0, 25);
            this.m_gestionnaireModeEdition.SetModeEdition(this.pageDefChamps, sc2i.win32.common.TypeModeEdition.Autonome);
            this.m_extModulesAssociator.SetModules(this.pageDefChamps, "");
            this.pageDefChamps.Name = "pageDefChamps";
            this.pageDefChamps.Selected = false;
            this.pageDefChamps.Size = new System.Drawing.Size(794, 283);
            this.m_extStyle.SetStyleBackColor(this.pageDefChamps, sc2i.win32.common.CExtStyle.EnumCouleurs.None);
            this.m_extStyle.SetStyleForeColor(this.pageDefChamps, sc2i.win32.common.CExtStyle.EnumCouleurs.None);
            this.pageDefChamps.TabIndex = 10;
            this.pageDefChamps.Title = "Custom Fields Definition|278";
            // 
            ...
            this.m_panelEditDefinisseurChampsCustom.Location = new System.Drawing.Point(10, 13);
            ...
            this.m_panelEditDefinisseurChampsCustom.Size = new System.Drawing.Size(776, 259);
            ...
            this.m_extModulesAssociator.SetModules(this.pageEOs, "");
            this.pageEOs.Name = "pageEOs";
            this.pageEOs.Selected = false;
            this.pageEOs.Size = new System.Drawing.Size(794, 283);
            ...
            this.m_panelEOS.Location = new System.Drawing.Point(6, 5);
            ...
            this.m_panelEOS.Size = new System.Drawing.Size(785, 275);
            ...
            this.pageFilles.Title = "Child Categories|10098";
            // 
            ...
            this.Name = "CFormEditionCategorieGED";
            ...
            this.pageDefChamps.ResumeLayout(false);
		...
		private CCategorieGED CategorieGED
		{
			get
			{
				return (CCategorieGED)ObjetEdite;
			}
		}
		//-------------------------------------------------------------------------
