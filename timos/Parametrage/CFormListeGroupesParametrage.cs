...
namespace timos
{
	[sc2i.win32.data.navigation.ObjectListeur(typeof(CGroupeParametrage))]
	public class CFormListeGroupesParametrage : CFormListeStandardTimos, IFormNavigable
	{
		
		private System.ComponentModel.IContainer components = null;

		public CFormListeGroupesParametrage()
			:base(typeof(CGroupeParametrage))
		{
		...
		private void InitializeComponent()
		{
			...
			// 
			// CFormListeGroupesParametrage
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
			this.ClientSize = new System.Drawing.Size(448, 376);
			this.Name = "CFormListeGroupesParametrage";
        ...
        {
            return I.T("Setting Groups list|987");
		}
		//-------------------------------------------------------------------
	}
}
