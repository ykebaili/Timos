...
namespace timos
{
	[sc2i.win32.data.navigation.ObjectListeur(typeof(C2iRapportCrystal))]
	public class CFormListeRapportsCrystal : timos.CFormListeStandardTimos, IFormNavigable
	{
		
		private System.ComponentModel.IContainer components = null;

		public CFormListeRapportsCrystal()
			:base(typeof(C2iRapportCrystal))
		{
		...
		private void InitializeComponent()
		{
			...
			// 
			// CFormListeRapportsCrystal
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
			this.ClientSize = new System.Drawing.Size(448, 376);
			this.Name = "CFormListeRapportsCrystal";
		...
		protected override void InitPanel()
		{
			m_panelListe.InitFromListeObjets(
				m_listeObjets,
				typeof(C2iRapportCrystal),	
				typeof(CFormEditionRapportCrystal),
				null, "");
