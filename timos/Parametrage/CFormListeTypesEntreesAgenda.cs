...
namespace timos
{
	[sc2i.win32.data.navigation.ObjectListeur(typeof(CTypeEntreeAgenda))]
	public class CFormListeTypesEntreesAgenda : CFormListeStandardTimos, IFormNavigable
	{
		
		private System.ComponentModel.IContainer components = null;

		public CFormListeTypesEntreesAgenda()
			:base(typeof(CTypeEntreeAgenda))
		{
		...
		private void InitializeComponent()
		{
			...
			// 
			// CFormListeTypesEntreesAgenda
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
			this.ClientSize = new System.Drawing.Size(448, 376);
			this.Name = "CFormListeTypesEntreesAgenda";
		...
		protected override void InitPanel()
		{
			m_panelListe.InitFromListeObjets(
				...
				typeof(CFormEditionTypeEntreeAgenda),
				null, "");
        ...
        {
            return I.T("Diary entry Type list|1001");
		}
		//-------------------------------------------------------------------
	}
}
