...
namespace timos
{
	[sc2i.win32.data.navigation.ObjectListeur(typeof(CModeleTexte))]
	public class CFormListeModeleTexte : CFormListeStandardTimos, IFormNavigable
	{
		
		private System.ComponentModel.IContainer components = null;

		public CFormListeModeleTexte()
			:base(typeof(CModeleTexte))
		{
		...
		protected override void InitPanel()
		{
			m_panelListe.InitFromListeObjets(
				m_listeObjets,
				typeof(CModeleTexte),	
				typeof(CFormEditionModeleTexte),
				null, "");
