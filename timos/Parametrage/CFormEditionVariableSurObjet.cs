...
namespace timos
{
	[sc2i.win32.data.navigation.ObjectEditeur(typeof(CVariableSurObjet))]
	public class CFormEditionVariableSurObjet : CFormEditionStdTimos, IFormNavigable
	{
		...
		public CFormEditionVariableSurObjet()
			:base()
		{
		...
		private void InitializeComponent()
		{
            ...
            this.label1.Text = "Variable name|979";
            // 
            // m_txtLibelle
            // 
            ...
            this.m_txtLibelle.Text = "[Name]|30301";
            // 
            // c2iPanelOmbre4
            // 
            ...
            this.c2iPanelOmbre4.Size = new System.Drawing.Size(592, 148);
            ...
            this.c2iTextBox1.Location = new System.Drawing.Point(132, 40);
            ...
            this.c2iTextBox1.Size = new System.Drawing.Size(436, 88);
            ...
            this.Name = "CFormEditionVariableSurObjet";
		...
		#endregion
		//-------------------------------------------------------------------------
		private CVariableSurObjet VariableSurObjet
		{
			get
			{
				return (CVariableSurObjet)ObjetEdite;
			}
		}
		//-------------------------------------------------------------------------
		protected override CResultAErreur MyInitChamps()
		{
			...
			AffecterTitre(I.T( "Variable|978")+" "+ VariableSurObjet.Nom);
			return result;
		}
		//-------------------------------------------------------------------------
	}
