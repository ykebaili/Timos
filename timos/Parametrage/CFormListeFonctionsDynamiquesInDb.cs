...
namespace timos
{
	[sc2i.win32.data.navigation.ObjectListeur(typeof(CFonctionDynamiqueInDb))]
	public class CFormListeFonctionsDynamiquesInDb : CFormListeStandardTimos, IFormNavigable
	{
		
		private System.ComponentModel.IContainer components = null;

		public CFormListeFonctionsDynamiquesInDb()
			:base(typeof(CFonctionDynamiqueInDb))
		{
		...
		private void InitializeComponent()
		{
			...
			// 
			// CFormListeFonctionsDynamiquesInDb
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
			this.ClientSize = new System.Drawing.Size(448, 376);
			this.Name = "CFormListeFonctionsDynamiquesInDb";
        ...
        {
            return I.T("Dynamic functions|20842");
		}
