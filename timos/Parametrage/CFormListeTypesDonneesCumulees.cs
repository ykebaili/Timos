...
namespace timos
{
	[sc2i.win32.data.navigation.ObjectListeur(typeof(CTypeDonneeCumulee))]
	public class CFormListeTypesDonneesCumulees : CFormListeStandardTimos, IFormNavigable
	{
		
		private System.ComponentModel.IContainer components = null;

		public CFormListeTypesDonneesCumulees()
			:base(typeof(CTypeDonneeCumulee))
		{
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CFormListeTypesDonneesCumulees));
            ...
            // 
            // CFormListeTypesDonneesCumulees
            // 
            this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
            this.ClientSize = new System.Drawing.Size(448, 376);
            this.Name = "CFormListeTypesDonneesCumulees";
		...
		protected override void InitPanel()
		{
			m_panelListe.InitFromListeObjets(
				m_listeObjets,
				typeof(CTypeDonneeCumulee),	
				typeof(CFormEditionTypeDonneeCumulee),
				null,"");
        ...
        {
            return I.T("Cumulated Data Type list|999");
		}
		//-------------------------------------------------------------------
	}
}
