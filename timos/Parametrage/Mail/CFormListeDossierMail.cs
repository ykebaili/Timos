...
namespace timos
{
	[sc2i.win32.data.navigation.ObjectListeur(typeof(CDossierMail))]
	public class CFormListeDossierMail : CFormListeStandardTimos, IFormNavigable
	{
		
		private System.ComponentModel.IContainer components = null;

        public CFormListeDossierMail()
			:base(typeof(CDossierMail))
		{
