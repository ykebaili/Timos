...
namespace futurocom.win32.sig
{
	...
	{
        private CWndSigMapView m_vearthControl = new CWndSigMapView();
			...
			IFournisseurProprietesDynamiques fournisseurProprietes)
		{
            ...
            try
            {
                ...
                m_vearthControl.Zoom = 4;
                switch (mapView.MapSetup.MapMode)
                {
                ...
                m_vearthControl.ShowMarkerOnClick = mapView.ShowMarkerOnClick;
            }
            catch { }
        ...
        {
            if (m_vearthControl != null)
                m_vearthControl.AddStaticMap(carte);
        }
        ...
        {
            if (m_vearthControl != null)
                m_vearthControl.RemoveStaticMap(carte);
        }
