...
<script runat="server">
    ...
    {
        sc2i.multitiers.client.CSessionClient.GlobalUseSessionUtilisateurData = false;
        timos.client.CInitialiseurClientTimos.InitClientTimos(new timos.web.CTimosWebRegistre());
