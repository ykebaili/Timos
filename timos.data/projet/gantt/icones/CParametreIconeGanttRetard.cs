...
{
    [NomConvivialParametreIconeGantt("Standard Delay Icon", true)]
    public class CParametreIconeGanttRetard : IParametreIconeGantt
    {
        ...
        {
            if ( element.DateDebutReelle == null && element.DateDebut < DateTime.Now )
            {
                string strTooltip = "";
                if (Tooltip != null)
                {
