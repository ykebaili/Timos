...
namespace timos.data
{
    ...
    public class C2iLabelDeSchema : C2iElementDeSchemaStatique
    {
        ...
        public C2iLabelDeSchema(int nIdContexteDonnee)
        ...
        private string m_strTexte = "Text";
