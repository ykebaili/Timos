...
namespace TimosLauncher
{
	...
	public class CFormDemarrage : System.Windows.Forms.Form, IInformeurDeSuivi
	{
		...
		private void InitializeComponent()
		{
            ...
            this.pictureBox3.Image = global::TimosLauncher.Properties.Resources.flower_banner;
            ...
            this.pictureBox2.Image = global::TimosLauncher.Properties.Resources.Logo_timos;
            ...
            this.pictureBox1.Image = global::TimosLauncher.Properties.Resources.Logo_futurocom_seul;
		...
		private string RepertoireAppli
		{
			get
			{
				return AppDomain.CurrentDomain.BaseDirectory+"Timos";
			}
		}

		public void StartThreadUpdate()
		{
			string strPort = new CTimosRegistreLauncher().GetLocalPort().ToString();
			...
			{
				if ( m_resultUpdate )
					m_resultUpdate = updater.UpdateApp ("SMT_WIN32_APP", RepertoireAppli, this, false);
				if ( !m_resultUpdate )
