...
namespace futurocom.snmp.Mib
{
    ...
    /// </summary>
    public sealed class Symbol : IEquatable<Symbol>, I2iSerializable
    {
        ...
        internal static readonly Symbol Objects = new Symbol("OBJECTS");
        internal static readonly Symbol Entreprise = new Symbol("ENTERPRISE");
        internal static readonly Symbol Variables = new Symbol("VARIABLES");
        ...
        internal void Expect(string strExpected)
        {
            Validate(_text != strExpected, strExpected + " expected");
        }
        ...
        public CResultAErreur Serialize(C2iSerializer serializer)
        {
            ...
            if (!result)
                return result;
            serializer.TraiteString(ref _text);
            serializer.TraiteInt(ref _row);
            serializer.TraiteInt(ref _column);
            serializer.TraiteString(ref _file);
            return result;
        }
    }
}