...
namespace futurocom.snmp.Messaging
{
    ...
    public class Discoverer
    {
        ...
        {            
            while (true)
            {
                ...
                try
                {
                    ...
                    ThreadPool.QueueUserWorkItem(HandleMessage, new MessageParams(remote, buffer, count, remote, 0));
                }
        ...
        {
            foreach (var message in MessageFactory.ParseMessages(param.EndPoint, param.GetBytes(), 0, param.Number, Empty))
            {
